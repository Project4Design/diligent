...
@section('title','Van quote - '.config('app.name'))
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select id="vehicle_body_type" class="form-control" name="vehicle_body_type" required>
                  ...
                  <option value="Box Van">Box Van</option><option value="Canteen">Canteen</option><option value="Crew Cab">Crew Cab</option><option value="Curtainside">Curtainside</option>
                  <option value="Double Cab">Double Cab</option><option value="Dropside">Dropside</option><option value="Flat Bed">Flat Bed</option><option value="Horsebox">Horsebox</option>
                  <option value="Hot Food Dispenser">Hot Food Dispenser</option><option value="Ice Cream Van">Ice Cream Van</option><option value="Loader">Loader</option><option value="Milk Float">Milk Float</option>
                  <option value="Mobile Shop">Mobile Shop</option><option value="Refrigerated / Insulated Van">Refrigerated / Insulated Van</option><option value="Tipper">Tipper</option><option value="Other">Other</option>
                </select>
              </div>
            </div>
          </div><!--Row-->
