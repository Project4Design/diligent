...
@section('title','Van - '.config('app.name'))
...
<div class="container-fluid">
	<section class="row">
	  ...
	  <div class="col-md-10 col-md-offset-1">
	    <h1 class="text-center" style="color:#B51235;margin:30px 0">Van Insurance</h1>
	    <div class="row">
	    	...
	    	<div class="col-md-9">
	      	...
	      	<div class="col-md-4">
	      		<img class="img-responsive" src="img/van-insure-1-211x160.jpg">
	      	</div>
	      	...
	      	<div class="col-md-12">
	      		...
	      		<p class="text-justify">
	      			...
	      			<a href="{{ url('/vans-quote') }}">Get a tailored quote</a>
	      		</p>
	      	</div>
	      	...
	      	<div class="col-md-12">
		        ...
		        <div class="col-xs-12 col-md-2">
		            ...
		            <a href="{{ url('/fleet') }}">
		            	<div class="container-img">
		              	<img src="img/fleet.svg" alt="Fleets">
		              </div>
