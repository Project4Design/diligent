...
<div class="container-fluid">
  <section class="row">
    ...
    <div class="col-md-10 col-md-offset-1">
      <h1 class="text-center" style="color:#B51235;margin:30px 0">Home Insurance</h1>
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="col-md-8">
        	...
        	<div class="col-md-4">
        		<img class="img-responsive" src="img/the-delta-display-home.jpg">
        	</div>
        	...
        	<div class="col-md-12">
        		...
        		<p class="text-justify">
        			...
        			<a href="{{ url('home-quote') }}">Get a tailored quote</a>
        		</p>
        	</div>

			    <div class="col-xs-12 col-md-4 col-md-offset-4">
			      <a class="btn btn-quote btn-block" href="{{ url('/home-quote') }}">Get a quote</a>
			    </div>
